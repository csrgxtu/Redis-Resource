 ...
 * 最后修正：2009-12-18
 **/
var IMAGESPATH = '/images/layer/'; //图片路径配置
...
Dialog.prototype.create = function () {
  ...
  <table id="_DialogTable_' + this.ID + '" width="' + (this.Width + 26) + '" cellspacing="0" cellpadding="0" border="0" onselectstart="return false;" style="-moz-user-select: none; font-size:12px; line-height:1.4;">\
    ...
    <tr valign="top">\
      ...
      <td align="center"><table width="100%" cellspacing="0" cellpadding="0" border="0" style="background:#ffffff">\
        ...
        return "";
          ...
          <tr id="_ButtonRow_' + this.ID + '" style="' + (this.ShowButtonRow ? "" : "display:none") + '">\
            <td height="36"><div id="_DialogButtons_' + this.ID + '" style="border-top: 1px solid #DADEE5; padding: 8px 20px; text-align: right; background-color:#f6f6f6;">\
                <input type="button" class="buttonStyle" value="确 定" id="_ButtonOK_' + this.ID + '" style="width:50px;height:25px;"/>\
                <input type="button" class="buttonStyle" value="取 消" onclick="Dialog.getInstance(\'' + this.ID + '\').close();" id="_ButtonCancel_' + this.ID + '" style="height:25px;width:50px;"/>\
              </div></td>\
          </tr>\
        </table></td>\
