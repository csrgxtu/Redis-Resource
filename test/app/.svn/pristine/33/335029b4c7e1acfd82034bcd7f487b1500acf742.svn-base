...
module.exports = {
    index: function (req, res) {
        ...
        return res.view('xfjwt/index', { permission: resu,data: info, title: '首页', menu: 'index' });
        })
    },
    ...
    appindex: function (req, res) {
        ...
        var resu = result[0];
        var resu = resu["group_concat(r.ResourceUrl)"];
        return res.view('appindex', { permission: resu,data: info, title: '首页', menu: 'index' , layout: null});
        })
    },
