...
module.exports = {
  ...
  save: function(req,res){
   ...
   console.log("XfImage :zaiQingId = " + zaiQingId + " baiduLat = " + baiduLat + " baiduLon = " + baiduLon + " imageType + " + imageType);
  ...
  read: function(req,res){
		...
		if (zaiQingName != null && zaiQingName != '') {
			countSql = countSql + " AND zq.ZaiQingName LIKE '%" + zaiQingName + "%'";
			readSql = readSql + " AND zq.ZaiQingName LIKE '%" + zaiQingName + "%'";
		}
		if (imageType != null && imageType != '') {
			countSql = countSql + " AND pic.ImageType = '" + imageType + "'";
			readSql = readSql + " AND pic.ImageType = '" + imageType + "'";
		}
		
		readSql = readSql + " order by pic.CreatedTime desc " + " LIMIT " + start + ", " + pageSize;
